...
#include "yaCamera.h"
ya::Jewelry01::Jewelry01(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Jewelry01::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}

ya::Jewelry01::~Jewelry01()
{
}

void ya::Jewelry01::OnInit()
{
}

void ya::Jewelry01::OnActive()
{
}

void ya::Jewelry01::OnInActive()
{
}

void ya::Jewelry01::OnTick()
{
...
void ya::Jewelry01::OnRender(HDC hdc)
{
...
void ya::Jewelry01::OnClear()
{
}

void ya::Jewelry01::Click()
{
	Vector2 mousePos = Input::GetMousePos();
