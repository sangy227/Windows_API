...
ya::Dagger01::Dagger01(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Dagger01::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}

ya::Dagger01::~Dagger01()
{
}

void ya::Dagger01::OnInit()
{
}

void ya::Dagger01::OnActive()
{
}

void ya::Dagger01::OnInActive()
{
}

void ya::Dagger01::OnTick()
{
...
void ya::Dagger01::OnRender(HDC hdc)
{
...
void ya::Dagger01::OnClear()
{
}

void ya::Dagger01::Click()
{
	Vector2 mousePos = Input::GetMousePos();
...
void ya::Dagger01::Select_Monster_Target()
{
