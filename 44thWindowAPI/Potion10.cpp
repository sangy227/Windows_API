...
#include "yaPlayer.h"
#include "yaScene.h"
ya::Potion10::Potion10(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Potion10::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 2;
}

ya::Potion10::~Potion10()
{
}

void ya::Potion10::OnInit()
{
}

void ya::Potion10::OnActive()
{
}

void ya::Potion10::OnInActive()
{
}

void ya::Potion10::OnTick()
{
...
void ya::Potion10::OnRender(HDC hdc)
{
...
void ya::Potion10::OnClear()
{
}

void ya::Potion10::Click()
{
	Vector2 mousePos = Input::GetMousePos();
