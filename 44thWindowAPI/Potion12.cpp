...
#include "yaCamera.h"
ya::Potion12::Potion12(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Potion12::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 2;
}

ya::Potion12::~Potion12()
{
}

void ya::Potion12::OnInit()
{
}

void ya::Potion12::OnActive()
{
}

void ya::Potion12::OnInActive()
{
}

void ya::Potion12::OnTick()
{
...
void ya::Potion12::OnRender(HDC hdc)
{
...
void ya::Potion12::OnClear()
{
}

void ya::Potion12::Click()
{
	Vector2 mousePos = Input::GetMousePos();
