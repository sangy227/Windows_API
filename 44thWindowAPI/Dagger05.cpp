...
#include "yaPlayer.h"
#include "yaScene.h"
ya::Dagger05::Dagger05(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Dagger05::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}

ya::Dagger05::~Dagger05()
{
}

void ya::Dagger05::OnInit()
{
}

void ya::Dagger05::OnActive()
{
}

void ya::Dagger05::OnInActive()
{
}

void ya::Dagger05::OnTick()
{
...
void ya::Dagger05::OnRender(HDC hdc)
{
...
void ya::Dagger05::OnClear()
{
}

void ya::Dagger05::Click()
{
	Vector2 mousePos = Input::GetMousePos();
