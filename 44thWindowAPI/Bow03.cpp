...
ya::Bow03::Bow03(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Bow03::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 4;
}
...
void ya::Bow03::OnInit()
{
}

void ya::Bow03::OnActive()
{
}

void ya::Bow03::OnInActive()
{
}

void ya::Bow03::OnTick()
{
...
void ya::Bow03::OnRender(HDC hdc)
{
