...
#include "yaCamera.h"
ya::Armor01::Armor01(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Armor01::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}
...
void ya::Armor01::OnInit()
{
}

void ya::Armor01::OnActive()
{
}

void ya::Armor01::OnInActive()
{
}

void ya::Armor01::OnTick()
{
...
void ya::Armor01::OnRender(HDC hdc)
{
...
void ya::Armor01::OnClear()
{
}

void ya::Armor01::Click()
{
	Vector2 mousePos = Input::GetMousePos();
