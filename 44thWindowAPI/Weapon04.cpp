...
ya::Weapon04::Weapon04(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Weapon04::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 4;
}

ya::Weapon04::~Weapon04()
{
}

void ya::Weapon04::OnInit()
{
}

void ya::Weapon04::OnActive()
{
}

void ya::Weapon04::OnInActive()
{
}

void ya::Weapon04::OnTick()
{
...
void ya::Weapon04::OnRender(HDC hdc)
{
	TransparentBlt(hdc, (int)mScreenPos.x, (int)mScreenPos.y,
		mImage->GetWidth() * 4.0f, mImage->GetHeight() * 4.5f,
...
void ya::Weapon04::OnClear()
{
}

void ya::Weapon04::Click()
{
	Vector2 mousePos = Input::GetMousePos();
...
void ya::Weapon04::Select_Monster_Target()
{
