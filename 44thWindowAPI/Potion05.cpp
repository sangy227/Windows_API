...
#include "yaCamera.h"
ya::Potion05::Potion05(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Potion05::Click, this);
	mXarrIndex = 2;
	mYarrIndex = 1;
}

ya::Potion05::~Potion05()
{
}

void ya::Potion05::OnInit()
{
}

void ya::Potion05::OnActive()
{
}

void ya::Potion05::OnInActive()
{
}

void ya::Potion05::OnTick()
{
...
void ya::Potion05::OnRender(HDC hdc)
{
...
void ya::Potion05::OnClear()
{
}

void ya::Potion05::Click()
{
	Vector2 mousePos = Input::GetMousePos();
