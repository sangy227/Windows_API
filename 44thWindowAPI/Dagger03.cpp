...
#include "yaCamera.h"
ya::Dagger03::Dagger03(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Dagger03::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}
ya::Dagger03::~Dagger03()
{
}

void ya::Dagger03::OnInit()
{
}

void ya::Dagger03::OnActive()
{
}

void ya::Dagger03::OnInActive()
{
}

void ya::Dagger03::OnTick()
{
...
void ya::Dagger03::OnClear()
{
}

void ya::Dagger03::Click()
{
	Vector2 mousePos = Input::GetMousePos();
