...
ya::Shield05::Shield05(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Shield05::Click, this);
	mXarrIndex = 2;
	mYarrIndex = 2;
}

ya::Shield05::~Shield05()
{
}

void ya::Shield05::OnInit()
{
}

void ya::Shield05::OnActive()
{
}

void ya::Shield05::OnInActive()
{
}

void ya::Shield05::OnTick()
{
...
void ya::Shield05::OnRender(HDC hdc)
{
...
void ya::Shield05::OnClear()
{
}

void ya::Shield05::Click()
{
	Vector2 mousePos = Input::GetMousePos();
