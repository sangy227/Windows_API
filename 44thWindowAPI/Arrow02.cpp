...
#include "yaCamera.h"
ya::Arrow02::Arrow02(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Arrow02::Click, this);
	mXarrIndex = 2;
	mYarrIndex = 1;
}
...
void ya::Arrow02::OnInit()
{
}

void ya::Arrow02::OnActive()
{
}

void ya::Arrow02::OnInActive()
{
}

void ya::Arrow02::OnTick()
{
...
void ya::Arrow02::OnRender(HDC hdc)
{
...
void ya::Arrow02::OnClear()
{
}

void ya::Arrow02::Click()
{
	Vector2 mousePos = Input::GetMousePos();
