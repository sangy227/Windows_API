...
#include "yaCamera.h"
ya::Armor04::Armor04(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Armor04::Click, this);
	mXarrIndex = 2;
	mYarrIndex = 2;
}
...
void ya::Armor04::OnInit()
{
}

void ya::Armor04::OnActive()
{
}

void ya::Armor04::OnInActive()
{
}

void ya::Armor04::OnTick()
{
...
void ya::Armor04::OnRender(HDC hdc)
{
...
void ya::Armor04::OnClear()
{
}

void ya::Armor04::Click()
{
	Vector2 mousePos = Input::GetMousePos();
