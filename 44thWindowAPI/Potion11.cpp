...
#include "yaPlayer.h"
#include "yaScene.h"
ya::Potion11::Potion11(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Potion11::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 2;
}

ya::Potion11::~Potion11()
{
}

void ya::Potion11::OnInit()
{
}

void ya::Potion11::OnActive()
{
}

void ya::Potion11::OnInActive()
{
}

void ya::Potion11::OnTick()
{
...
void ya::Potion11::OnRender(HDC hdc)
{
...
void ya::Potion11::OnClear()
{
}

void ya::Potion11::Click()
{
	Vector2 mousePos = Input::GetMousePos();
