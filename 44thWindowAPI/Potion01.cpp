...
#include "yaCamera.h"
ya::Potion01::Potion01(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Potion01::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}

ya::Potion01::~Potion01()
{
}

void ya::Potion01::OnInit()
{
}

void ya::Potion01::OnActive()
{
}

void ya::Potion01::OnInActive()
{
}

void ya::Potion01::OnTick()
{
...
void ya::Potion01::OnRender(HDC hdc)
{
...
void ya::Potion01::OnClear()
{
}

void ya::Potion01::Click()
{
	Vector2 mousePos = Input::GetMousePos();
