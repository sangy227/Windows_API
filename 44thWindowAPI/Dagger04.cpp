...
#include "yaCamera.h"
ya::Dagger04::Dagger04(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Dagger04::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}
ya::Dagger04::~Dagger04()
{
}

void ya::Dagger04::OnInit()
{
}

void ya::Dagger04::OnActive()
{
}

void ya::Dagger04::OnInActive()
{
}

void ya::Dagger04::OnTick()
{
...
void ya::Dagger04::OnRender(HDC hdc)
{
...
void ya::Dagger04::OnClear()
{
}

void ya::Dagger04::Click()
{
	Vector2 mousePos = Input::GetMousePos();
