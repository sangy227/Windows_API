...
#include "yaCamera.h"
ya::Armor02::Armor02(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Armor02::Click, this);
	mXarrIndex = 2;
	mYarrIndex = 1;
}
...
void ya::Armor02::OnInit()
{
}

void ya::Armor02::OnActive()
{
}

void ya::Armor02::OnInActive()
{
}

void ya::Armor02::OnTick()
{
...
void ya::Armor02::OnRender(HDC hdc)
{
	TransparentBlt(hdc, (int)mScreenPos.x, (int)mScreenPos.y,
		mImage->GetWidth() * 4.5f, mImage->GetHeight() * 3.5f,
...
void ya::Armor02::OnClear()
{
}

void ya::Armor02::Click()
{
	Vector2 mousePos = Input::GetMousePos();
