...
ya::Shield03::Shield03(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Shield03::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 2;
}

ya::Shield03::~Shield03()
{
}

void ya::Shield03::OnInit()
{
}

void ya::Shield03::OnActive()
{
}

void ya::Shield03::OnInActive()
{
}

void ya::Shield03::OnTick()
{
...
void ya::Shield03::OnRender(HDC hdc)
{
...
void ya::Shield03::OnClear()
{
}

void ya::Shield03::Click()
{
	Vector2 mousePos = Input::GetMousePos();
