...
ya::Armor06::Armor06(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Armor06::Click, this);
	mXarrIndex = 2;
	mYarrIndex = 1;
}
...
void ya::Armor06::OnInit()
{
}

void ya::Armor06::OnActive()
{
}

void ya::Armor06::OnInActive()
{
}

void ya::Armor06::OnTick()
{
...
void ya::Armor06::OnRender(HDC hdc)
{
...
void ya::Armor06::OnClear()
{
}

void ya::Armor06::Click()
{
	Vector2 mousePos = Input::GetMousePos();
