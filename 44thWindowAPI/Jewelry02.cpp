...
#include "yaCamera.h"
ya::Jewelry02::Jewelry02(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Jewelry02::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}

ya::Jewelry02::~Jewelry02()
{
}

void ya::Jewelry02::OnInit()
{
}

void ya::Jewelry02::OnActive()
{
}

void ya::Jewelry02::OnInActive()
{
}

void ya::Jewelry02::OnTick()
{
...
void ya::Jewelry02::OnRender(HDC hdc)
{
...
void ya::Jewelry02::OnClear()
{
}

void ya::Jewelry02::Click()
{
	Vector2 mousePos = Input::GetMousePos();
