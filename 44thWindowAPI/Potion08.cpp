...
#include "yaCamera.h"
ya::Potion08::Potion08(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Potion08::Click, this);
	mXarrIndex = 2;
	mYarrIndex = 1;
}

ya::Potion08::~Potion08()
{
}

void ya::Potion08::OnInit()
{
}

void ya::Potion08::OnActive()
{
}

void ya::Potion08::OnInActive()
{
}

void ya::Potion08::OnTick()
{
...
void ya::Potion08::OnRender(HDC hdc)
{
...
void ya::Potion08::OnClear()
{
}

void ya::Potion08::Click()
{
	Vector2 mousePos = Input::GetMousePos();
