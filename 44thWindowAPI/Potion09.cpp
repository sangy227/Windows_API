...
#include "yaCamera.h"
ya::Potion09::Potion09(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Potion09::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 2;
}

ya::Potion09::~Potion09()
{
}

void ya::Potion09::OnInit()
{
}

void ya::Potion09::OnActive()
{
}

void ya::Potion09::OnInActive()
{
}

void ya::Potion09::OnTick()
{
...
void ya::Potion09::OnRender(HDC hdc)
{
...
void ya::Potion09::OnClear()
{
}

void ya::Potion09::Click()
{
	Vector2 mousePos = Input::GetMousePos();
