...
#include "yaCamera.h"
ya::Potion02::Potion02(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Potion02::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}

ya::Potion02::~Potion02()
{
}

void ya::Potion02::OnInit()
{
}

void ya::Potion02::OnActive()
{
}

void ya::Potion02::OnInActive()
{
}

void ya::Potion02::OnTick()
{
...
void ya::Potion02::OnRender(HDC hdc)
{
...
void ya::Potion02::OnClear()
{
}

void ya::Potion02::Click()
{
	Vector2 mousePos = Input::GetMousePos();
