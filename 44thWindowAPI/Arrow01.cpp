...
ya::Arrow01::Arrow01(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Arrow01::Click, this);
	mXarrIndex = 2;
	mYarrIndex = 1;
}
...
void ya::Arrow01::OnInit()
{
}

void ya::Arrow01::OnActive()
{
}

void ya::Arrow01::OnInActive()
{
}

void ya::Arrow01::OnTick()
{
...
void ya::Arrow01::OnRender(HDC hdc)
{
...
void ya::Arrow01::OnClear()
{
}

void ya::Arrow01::Click()
{
	Vector2 mousePos = Input::GetMousePos();
