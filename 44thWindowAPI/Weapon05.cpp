...
ya::Weapon05::Weapon05(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Weapon05::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 3;
}

ya::Weapon05::~Weapon05()
{
}

void ya::Weapon05::OnInit()
{
}

void ya::Weapon05::OnActive()
{
}

void ya::Weapon05::OnInActive()
{
}

void ya::Weapon05::OnTick()
{
...
void ya::Weapon05::OnRender(HDC hdc)
{
...
void ya::Weapon05::OnClear()
{
}

void ya::Weapon05::Click()
{
	Vector2 mousePos = Input::GetMousePos();
...
void ya::Weapon05::Select_Monster_Target()
{
