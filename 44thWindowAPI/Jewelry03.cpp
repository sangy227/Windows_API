...
#include "yaCamera.h"
ya::Jewelry03::Jewelry03(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Jewelry03::Click, this);
	mXarrIndex = 1;
	mYarrIndex = 1;
}

ya::Jewelry03::~Jewelry03()
{
}

void ya::Jewelry03::OnInit()
{
}

void ya::Jewelry03::OnActive()
{
}

void ya::Jewelry03::OnInActive()
{
}

void ya::Jewelry03::OnTick()
{
...
void ya::Jewelry03::OnRender(HDC hdc)
{
...
void ya::Jewelry03::OnClear()
{
}

void ya::Jewelry03::Click()
{
	Vector2 mousePos = Input::GetMousePos();
