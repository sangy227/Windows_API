...
ya::Potion06::Potion06(eUIType type)
	: UIItem(type)
{
	mOnClick = std::bind(&Potion06::Click, this);
	mXarrIndex = 2;
	mYarrIndex = 1;
}

ya::Potion06::~Potion06()
{
}

void ya::Potion06::OnInit()
{
}

void ya::Potion06::OnActive()
{
}

void ya::Potion06::OnInActive()
{
}

void ya::Potion06::OnTick()
{
...
void ya::Potion06::OnRender(HDC hdc)
{
...
void ya::Potion06::OnClear()
{
}

void ya::Potion06::Click()
{
	Vector2 mousePos = Input::GetMousePos();
